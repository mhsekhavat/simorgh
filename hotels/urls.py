...
from hotels.views import HotelSearchView, HotelUpdate, HotelView, hotels_list, HotelRegisterView, HotelAddImageView, HotelRemoveImage, HotelAddRoomClass, HotelEditRoomClass, HotelRemoveRoomClass
...
hotel_patterns = patterns(
    ...
    url(r'^update/removeRoomClass/(?P<room_class_pk>\d+)/$', HotelRemoveRoomClass.as_view(), name='hotel_delete_room_class'),
